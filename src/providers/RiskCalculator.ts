...
export class RiskCalculator {
  calculateRisk(address: string, addressType: string, collectedData: CollectedData): RiskAnalysis {
  ...
  private generateDescription(addressType: string, factors: string[], score: number, confidence: number): string {
