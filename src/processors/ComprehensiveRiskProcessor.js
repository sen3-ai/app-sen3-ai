...
exports.ComprehensiveRiskProcessor = void 0;
const ResponseProcessor_1 = require("./ResponseProcessor");
class ComprehensiveRiskProcessor extends ResponseProcessor_1.BaseResponseProcessor {
    getName() {
        return 'comprehensive';
    }
    process(address, addressType, collectedData) {
...
exports.ComprehensiveRiskProcessor = ComprehensiveRiskProcessor;
